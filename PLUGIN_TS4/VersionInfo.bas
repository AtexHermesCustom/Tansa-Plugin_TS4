...
Private Type VersionInformationType
...
Private Function VersionInformation(ByVal file_name As String) As VersionInformationType
On Error GoTo EH
    ...
    Exit Function
EH:
    Err.Raise Err.Number, "VersionInformation:" & Err.Source, Err.Description
End Function

Public Function GetProductVersion(sFile As String)
On Error GoTo EH
    Dim verInfo As VersionInformationType
    verInfo = VersionInformation(sFile)
    GetProductVersion = verInfo.ProductVersion
    Exit Function
EH:
    Err.Raise Err.Number, "GetProductVersion:" & Err.Source, Err.Description
End Function
